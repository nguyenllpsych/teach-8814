...
You can find the interactive webpage to edit and/or run the code yourself [here](https://nguyenllpsych.quarto.pub/psy8814-lab05/). Please wait for WEBR STATUS to be Ready.
...
# initialize a 10000 X 2 matrix to MSE for xbar and median
#   each row is the result for a repetition
#   column 1: MSE for xbar
#   column 2: MSE for median
compare_results <- matrix(nrow = r, ncol = 2)
colnames(compare_results) <- c("MSE-mean", "MSE-median")
...
for (i in 1:r) {
  ...
  # calculate and store MSE for each estimator
  compare_results[i, "MSE-mean"]   <- (xbar - mu)^2
  compare_results[i, "MSE-median"] <- (mdn - mu)^2
}
